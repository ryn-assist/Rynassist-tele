...
registerStart(bot); registerAdminCommands(bot); registerProductHandlers(bot); registerAccountHandlers(bot);
...
bot.launch().then(() => console.log(`${config.storeName} aktif.`)).catch((error) => {
